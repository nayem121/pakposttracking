...
export const metadata = {
  title: "Privacy Policy - Pak Post Tracking - Pakistan App",
  description:
    "Privacy policy for the Pak Post Tracking - Pakistan mobile application developed by Youth Empowerment Center.",
}
      ...
      <main className="container mx-auto px-4 py-12">
        <Card className="max-w-4xl mx-auto">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Pak Post Tracking - Pakistan App</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Effective Date: July 31, 2025</p>
          </CardHeader>
          <CardContent className="prose prose-gray dark:prose-invert max-w-none">
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              This privacy policy applies to the Pak Post Tracking - Pakistan app (hereby referred to as "Application")
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
              <p className="text-amber-800 dark:text-amber-200 text-sm">
                ...
                endorsed by Pakistan Post. We are an independent service provider offering tracking functionality for
                Pakistan Post parcels.
              </p>
            </div>
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <li>Pakistan Post tracking numbers you enter for parcel tracking purposes</li>
            </ul>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
